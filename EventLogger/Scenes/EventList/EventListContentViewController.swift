//
//  EventListContentViewController.swift
//  EventLogger
//
...
final class EventListContentViewController: BaseViewController<EventListReactor> {
    ...
    // MARK: Init (고정 필터 Reactor 주입)
    convenience init(reactor: EventListReactor) {
        self.init()
